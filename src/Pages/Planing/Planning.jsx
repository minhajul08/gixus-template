...
const Planning = () => {
    return (
       <div className="bg-slate-200  mt-[330px] p-20 min-h-screen flex gap-20">
         <div
        className="hero  w-[450px] h-5/5 items-center rounded-br-[5px]"
        style={{
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md p-10">
            <h1 className="mb-5 text-3xl font-bold text-justify">Have a view of our <br /> amazing projects with <br /> our clients</h1>
            ...
            <p className="text-2xl text-justify">Satisfaction guarantee <br />
            Ontime delivery</p>
          </div>
        </div>
      </div>
      ...
      <p className="text-3xl">Digital business planning</p>
      </div>
      <br />
      {/* <img src={} alt="" /> */}
      ...
      <p className="text-3xl">Business Program Management</p>
      </div>
      <br />
      <hr className="border border-solid w-full border-black" />
      <br />
      ...
      <p className="text-3xl">Strategy development</p>
